...
export const WEATHER_SOURCES = Object.freeze([
  ...
  },
  {
    ...
    localityPrecision: 'coordinate-based GFS model output',
    horizons: {
      hourlyHours: null,
      dailyDays: 16,
      fourteenDay: true,
  ...
  },
  {
    ...
    localityPrecision: 'coordinate-based ECMWF model output',
    horizons: {
      hourlyHours: null,
      dailyDays: 16,
      fourteenDay: true,
  ...
  },
  {
    ...
    localityPrecision: 'coordinate-based NBM model output for CONUS',
    horizons: {
      hourlyHours: null,
      dailyDays: 16,
      fourteenDay: true,
